...
# -*- coding: utf-8 -*-
"""
apool documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'apool'))
...
project = u'apool'
_full_version = apool.__version__
author = apool.__author__
copyright = apool.__copyright__
...
latex_documents = [
    (master_doc, 'apool.tex', u'apool Documentation',
     u'authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'apool', 'apool Documentation',
     [author], 1)
]
